...
<div id="contenedor" class="row grid grid-cols-3 gap-4" style="padding-top: 50px;"   >
    <div class="card mb-3" style="background-color: #cd7f50;">
        ...
        <div class="card-body" >
            <ul class="list-group list-group-flush" >
                <input type="hidden" id="rango" value="bronce">
            ...
            <a href="#" class="btn y mt-3 botonSuscribirse"
                style="background-color: #cd7f50; ">Suscribirse</a>
        </div>
    </div>
    ...
    <div class="card mb-3" style="background-color: #cccccc; ">
        ...
        <div class="card-body" >
            <ul class="list-group list-group-flush">
                <input type="hidden" id="rango" value="plata">
    ...
    <div class="card mb-3" style="background-color: #ffd700; color: #000;">
        ...
        <div class="card-body">
            <ul class="list-group list-group-flush">
                <input type="hidden" id="rango" value="oro">
...
botonSuscribirse.forEach((el) => {
    el.addEventListener("click", (e) => {
        e.preventDefault();
        // Access the value
        let closestInput = event.target.closest('.card').querySelector('#rango');
        let params = new FormData();
        params.append("rango", "bronce");
