...
CREATE TABLE `aviones` (
  ...
  KEY `aviones_ibfk_1` (`id_Vuelo`),
  CONSTRAINT `aviones_ibfk_1` FOREIGN KEY (`id_Vuelo`) REFERENCES `vuelos` (`id_Vuelo`) ON DELETE CASCADE
...
INSERT INTO `aviones` VALUES (1,61,'Boeing 747','N12345','523','1970'),(5,NULL,'ATR 72-600','I-OPQRS','70','2010'),(6,NULL,'Boeing 777','N67890','368','2003'),(7,NULL,'Airbus A320','D-EFGHI','150','2015'),(8,NULL,'Embraer E190','PR-ABCD','114','2013'),(9,NULL,'Bombardier Q400','C-DEFGH','78','2001'),(10,NULL,'ATR 42-600','I-JKLMN','48','2008');
...
-- Dump completed on 2024-05-23  2:25:35
